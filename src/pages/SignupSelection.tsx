...
const SignupSelection: React.FC = () => {
    ...
    const roles = [
        {
            id: "athlete",
            title: "selection.signup_roles.athlete.title",
            description: "selection.signup_roles.athlete.desc",
        ...
        {
            id: "coach",
            title: "selection.signup_roles.coach.title",
            description: "selection.signup_roles.coach.desc",
        ...
        {
            id: "academy",
            title: "selection.signup_roles.academy.title",
            description: "selection.signup_roles.academy.desc",
        ...
        {
            id: "sponsor",
            title: "selection.signup_roles.sponsor.title",
            description: "selection.signup_roles.sponsor.desc",
            ...
            <div className="max-w-5xl w-full">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-300">
                        {t('selection.select_role_signup')}
                    </p>
                </div>
                ...
                <div className="text-center mt-12">
                    <p className="text-gray-500 text-sm">
                        {t('selection.already_account')}{" "}
                        <a href="/service-selection" className="text-cyan-400 hover:text-cyan-300 underline">
                            {t('selection.login_here')}
                        </a>
                    </p>
                </div>
            </div>
